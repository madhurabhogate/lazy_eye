...
#define STATE_MENU					NSLocalizedString(@"Turn Lazy Eye Off", nil) // global status menu-item title when enabled
#define STATE_MENU_OFF				NSLocalizedString(@"Turn Lazy Eye On", nil) // global status menu-item title when disabled

#define HELP_TEXT					NSLocalizedString(@"When Lazy Eye is frontmost:\rPress Up/Down to alter color,\ror press Q to Quit.", nil)
#define HELP_TEXT_OFF				NSLocalizedString(@"Lazy Eye is Off.\rPress S to turn Shady on,\ror press Q to Quit.", nil)
...
@synthesize isRedControl;
@synthesize isGreenControl;
...
//        layer.opacity = 0;
        ...
        //red layer
        CALayer *redColorLayer = [CALayer layer];
        redColorLayer.delegate = self;
        [redColorLayer setName:@"child"];
        redColorLayer.frame = CGRectMake(0 ,0, width, height);
        [layer addSublayer:redColorLayer];
        [redColorLayer setNeedsDisplay];
        
        
        //green layer
//        CALayer *greenColorLayer = [CALayer layer];
//        greenColorLayer.delegate = self;
//        [greenColorLayer setName:@"child"];
//        greenColorLayer.frame = CGRectMake(0 ,0, width, height);
//        [layer addSublayer:greenColorLayer];
//        [greenColorLayer setNeedsDisplay];
...
//    self.thickness = [[NSUserDefaults standardUserDefaults] floatForKey:KEY_THICKNESS];
...
//- (IBAction)thicknessSliderChanged:(id)sender
//{
//    self.thickness = [sender floatValue];
//}
...
//    for( NSWindow* window in windows )
//        if ([[[[[window contentView] layer] sublayers] objectAtIndex:0] isKindOfClass:[CALayer class]]) {
//            CALayer *layer = [[[[window contentView] layer] sublayers] objectAtIndex:0];
